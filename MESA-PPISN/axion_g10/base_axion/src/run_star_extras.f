...
! ***********************************************************************
      ...
      real(dp), parameter :: axion_g10 = 1d0
      ...
      !Friedland-Giannotti-Wise, the extra part, axion energy losses formula may be different.
      subroutine other_neu(  &
         ...
         faxioncsi = (46.6754d0 + 0.843043d0*axioncsi) &
            /(44.44d0 + (8.7822d0 + 0.116255d0*axioncsi)*axioncsi) &
            *log(3.85d0 + 3.99d0/axioncsi)

         sprimakoff    =  4.66d-31*axionz2ye*faxioncsi*axion_g10*axion_g10*T*T*T*T
